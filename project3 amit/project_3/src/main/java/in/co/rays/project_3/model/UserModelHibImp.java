...
public class UserModelHibImp implements UserModelInt {
	...
	public long add(UserDTO dto) throws DuplicateRecordException, ApplicationException {
		...
		UserDTO exitDto = null;
		exitDto = findByLogin(dto.getLogin());
		if(exitDto!=null) {
	...
	/**
	 * find by user with the help of pk
	 * @param pk
	 * @return dto
	 * @throws ApplicationException
	 */
	...
	/**
	 * find user with the help of emailId
	 * @param emailId
	 * @return dto
	 * @throws ApplicationException
	 */
		...
		try {
			...
			if(dto!=null) {
				...
				if (dto.getDob() != null && dto.getDob().getDate() > 0) {
					//Date d = new Java.sql.Date(dto.getDob().getTime());
	...
	/**
	 * authenticate user with the help of loginid and password
	 * @param login
	 *  @param password
	 * @return dto
	 * @throws ApplicationException
	...
	/**
	 * change password with the help of loginid and password
	 * @param login
	 *  @param newPassword
	 *  @param oldPassword
	 * @return dto
	...
	/**
	 * get password with the help of loginid 
	 * @param login
	 * @return boolean
	 * @throws ApplicationException
